...
use crate::constants::general::{AMM_V4, AMM_V4_AUTHORITY, AMM_V4_FEES};
use solana_sdk::pubkey::Pubkey;

use bytemuck::{Pod, Zeroable};

// Add these derives to your existing structs
#[repr(C, packed)]
#[derive(Clone, Copy, Default, PartialEq, Pod, Zeroable, Debug)]
pub struct AmmInfo {
    /// Initialized status.
    pub status: u64,
